...
result = subprocess.run(["python","eda_nlp-master/code/augment.py","--input=original_train.txt","--output=augmented_train.txt"],
...
os.remove("eda_nlp-master/data/original_train.txt")
